...
(deftest bidi-handlers
  (testing "root resource routes"
    (let [db (create-database)
          ...
          list-hdlr (sapid.handler/bidi-list-root db table cols)
          create-hdlr (sapid.handler/bidi-create-root db table cols)
          fetch-hdlr (sapid.handler/bidi-fetch-root db table cols)
          put-hdlr (sapid.handler/bidi-put-root db table cols)
          patch-hdlr (sapid.handler/bidi-patch-root db table cols)
          delete-hdlr (sapid.handler/bidi-delete-root db table cols)]
  ...
  (testing "one-n resource routes"
    (let [db (create-database)
          ...
          list-hdlr (sapid.handler/bidi-list-one-n db table p-col cols)
          create-hdlr (sapid.handler/bidi-create-one-n db table p-col cols)
          fetch-hdlr (sapid.handler/bidi-fetch-one-n db table p-col cols)
          put-hdlr (sapid.handler/bidi-put-one-n db table p-col cols)
          patch-hdlr (sapid.handler/bidi-patch-one-n db table p-col cols)
          delete-hdlr (sapid.handler/bidi-delete-one-n db table p-col cols)]
  ...
  (testing "n-n resource routes"
    (let [db (create-database)
          ...
          list-a-hdlr (sapid.handler/bidi-list-n-n db "groups"  "groups_members"
                                                   "group_id" "member_id" cols)
          list-b-hdlr (sapid.handler/bidi-list-n-n db "members" "groups_members"
                                                   "member_id" "group_id" cols)
          create-hdlr (sapid.handler/bidi-create-n-n db "groups_members"
                                                     "member_id" "group_id" cols)
          delete-hdlr (sapid.handler/bidi-delete-n-n db "groups_members"
                                                     "member_id" "group_id" cols)]
      (let [rsc-a-1 {:id 1
                     :name "clojure meetup"
                     :created_at nil}
